...
async def telegram_webhook(request: Request):
    ...
    if text.lower() in {"/start", "start"}:
        ...
        bot.send_message(
            chat_id=chat_id,
            text="""👋 Привет! Я — твой AI-помощник, созданный решать задачи быстро и по делу.\n\n"
    Никаких сложных команд, промтов и инструкций.\n
    Просто выбери сферу, ответь на 3 вопроса — и получишь готовый, чёткий результат.\n\n
    📌 Для понимания как всё устроено — нажми «Help»\n
    ℹ А чтобы узнать, кто я и зачем я тебе нужен — кнопка «О проекте» рядом.\n\n
    Выбирай сферу — и поехали!""",
